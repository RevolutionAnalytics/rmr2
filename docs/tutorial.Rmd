...
The reduce function couldn't be simpler as it just computes column averages of a matrix of points sharing a center, which is the key. Please do not simply cut and paste this code into the console since it has been slightly rearranged from the original and won't work if you just do that. Please refer to the "kmeans.R" file in the "tests" directory in the package.
